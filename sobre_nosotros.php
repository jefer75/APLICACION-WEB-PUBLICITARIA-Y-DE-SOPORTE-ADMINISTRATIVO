            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-4">La empresa Arlequín Eventos fue creada en el año 2019 por Stephania Henao, quien es la fundadora y actual propietaria. Cuenta con una administradora, Gloria Henao. Durante los últimos 4 años, ha brindado felicidad y alegría a sus clientes. Está ubicada en la ciudad de Ibagué; sin embargo, también realiza eventos en municipios aledaños dentro del departamento. A lo largo de su existencia, ha proporcionado oportunidades de empleo a jóvenes, ayudando tanto al desarrollo personal como al desarrollo económico.</p>
                    ...
                    <div class="col-lg-6 about-img wow fadeInUp" data-wow-delay="0.5s">
                        <div class="row">
                            <div class="col-12 text-center">
                                <img class="img-fluid w-75 rounded-circle bg-light p-3" src="imagenes/contenido/Jefas.jpeg" alt="">
                            </div>
                            <div class="col-6 text-start" style="margin-top: -150px;">
                                <img class="img-fluid w-100 rounded-circle bg-light p-3" src="imagenes/logos/stephania.jpg" alt="">
                            </div>
                            <div class="col-6 text-end" style="margin-top: -150px;">
                                <img class="img-fluid w-100 rounded-circle bg-light p-3" src="imagenes/logos/gloria.jpeg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                    <div class="h-100 d-flex flex-column justify-content-center p-5">
                                        ...
                                        <p class="mb-4">Posicionarse como lideres en diseño, planificación, producción y resultados de eventos que dejen en nuestros clientes recuerdos inolvidables de momentos especiales 🌼.
                                        </p>
                            ...
                            <div class="row g-0">
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style="min-height: 400px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute w-100 h-100 rounded" src="imagenes/contenido/img113.jpg" style="object-fit: cover;">
                                    </div>
                                </div>
                                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                    <div class="h-100 d-flex flex-column justify-content-center p-5">
