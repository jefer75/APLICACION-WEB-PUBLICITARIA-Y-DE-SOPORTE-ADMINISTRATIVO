...
<main id="main" class="main">
  ...
  <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Eventos Completados</h5>
  ...
  <tbody>
    <?php
        $con_paquetes = $con->prepare("SELECT eventos.id_eventos, eventos.fecha_evento, paquetes.nombre_paquete, tipo_e.tipo_evento, eventos.lugar, eventos.cant_ninos, eventos.f_inicio, eventos.f_fin, eventos.hora_inicio, eventos.hora_fin, eventos.edad_home, eventos.descripcion, usuarios.nombre, estados.estado, detalle_animador.cedula
        FROM eventos
        ...
        INNER JOIN detalle_animador ON eventos.id_eventos = detalle_animador.id_eventos
        WHERE eventos.id_estado = 8 And detalle_animador.cedula = $cedula");
