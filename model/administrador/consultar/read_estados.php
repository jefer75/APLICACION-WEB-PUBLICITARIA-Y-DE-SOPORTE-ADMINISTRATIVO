...
if(isset($_POST['cerrar_sesion']))
{
    ...
    header('Location: ../registrar/estados.php');
}

?>
    <div class="formulario">

    <h1 class="title">Consulta de Estados</h1>
        ...
        <table>
            ...
            <tr>
                ...
                ('../actualizar y eliminar/estado.php?id=<?php echo $fila['id_estado'] ?>','','width=500, height=400, toolbar=NO'); void(null);">Click Aqui</a>
                </td>
            </tr>
            <?php
                  }
