...
if (isset($_POST['inm_excel'])) {
    ...
    $stmt = $con->prepare("SELECT articulos.id_articulo, articulos.nombre_A, articulos.descripcion, articulos.cantidad, articulos.valor, estados.estado FROM articulos INNER JOIN estados ON estados.id_estado = articulos.id_estado WHERE articulos.id_tipo_art = 4");
    $stmt->execute();
    ...
    header('Content-Disposition: attachment;filename="Articulos Inmobiliarios.xlsx"');
