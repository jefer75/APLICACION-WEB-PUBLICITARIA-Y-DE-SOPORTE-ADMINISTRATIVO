      ...
      if ($nombre_A=="" || $descripcion=="" || $id_tipo_art=="" || $cantidad=="" || $valor=="")
       {
         ...
         $insertSQL = $con->prepare("INSERT INTO `articulos`(`nombre_A`, `id_tipo_art`, `id_estado`, `descripcion`, `cantidad`, `valor`) VALUES('$nombre_A', '$id_tipo_art',0, '$descripcion', '$cantidad', '$valor')");
         $insertSQL -> execute();
...
<table class="table datatable">
  ...
  <tbody>
    <?php
        $con_paquetes = $con->prepare("SELECT * FROM articulos WHERE id_tipo_art = 0");
