   ...
   <div class="row">
    ...
    <style>
        .modal__container {
            ...
            width: 90%;
            max-width: 600px;
            max-height: 120%; /* Ajusta este valor según sea necesario */
...
<section class="modal ">
         ...
         <form method="post" name="formreg" id="formreg"   class="row g-3"  autocomplete="off"> 
           ...
           <div class="col-md-6">
             ...
             <input type="number" name="id_paquetes" id="id_paquetes"class="form-control" placeholder="paquete">
           </div>
           ...
           <div class="col-12">
             ...
             <label for="inputAddress5" class="form-label">Fecha de Evento</label>
...
<table class="table datatable">
  ...
  <tbody>
    <?php
        ...
        ,factura.valor_total FROM eventos INNER JOIN paquetes ON paquetes.id_paquetes = eventos.id_paquetes INNER JOIN tipo_e ON tipo_e.id_tipo_e = eventos.id_tipo_e INNER JOIN factura ON factura.valor_total  WHERE eventos.id_tipo_e = 3");
