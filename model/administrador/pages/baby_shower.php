...
<section class="modal ">
         ...
         <form method="post" name="formreg" id="formreg"   class="row g-3"  autocomplete="off"> 
           ...
           <div class="col-12">
             ...
             <label for="inputAddress5" class="form-label">Hora Fin</label>
...
<table class="table datatable">
  ...
  <tbody>
    <?php
        ...
        ,factura.valor_total FROM eventos INNER JOIN paquetes ON paquetes.id_paquetes = eventos.id_paquetes INNER JOIN tipo_e ON tipo_e.id_tipo_e = eventos.id_tipo_e INNER JOIN factura ON factura.valor_total  WHERE eventos.id_tipo_e = 2");
