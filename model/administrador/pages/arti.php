                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="cont" name="id_estado">
                                    ...
                                    while ($fila = $control->fetch(PDO::FETCH_ASSOC)) {
                                        echo "<option value='" . $fila['id_estado'] . "'>" . htmlspecialchars($fila['estado']) . "</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                <?php
                                $con_paquetes = $con->prepare("SELECT articulos.id_articulo, tipo_articulo.tipo_articulo, estados.estado, articulos.nombre_A, articulos.descripcion, articulos.cantidad, articulos.valor
                                    FROM articulos
                                ...
                                foreach ($paquetes as $fila) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="boton" onclick="window.open('../actualizar/articulos.php?id=<?php echo $fila['id_articulo']; ?>','','width=600,height=500,toolbar=NO');void(null);">
