...
<table class="table datatable">
  ...
  <tbody>
    <?php
        $con_paquetes = $con->prepare("SELECT factura. id_factura,factura. fecha, eventos. id_paquetes, paquetes. nombre_paquete, eventos.lugar, eventos.cant_ninos, eventos.hora_inicio, eventos.contacto, factura.descripcion, factura.valor_total  FROM factura INNER JOIN eventos ON eventos.id_eventos = factura.id_eventos INNER JOIN paquetes ON paquetes.id_paquetes = eventos.id_paquetes WHERE id_tipo_e = 4");
