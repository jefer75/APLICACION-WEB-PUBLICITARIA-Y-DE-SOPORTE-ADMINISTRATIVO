...
<body onload="centrar();">
        ...
        <table class="center">
            <form autocomplete="off" name="form_actualizar" method="POST">
                ...
                <tr>
                    <td>tipo articulo</td>
                    <td><input type="id_tipo_art" name="id_tipo_art" value="<?php echo $fila['id_tipo_art'] ?>"></td>                 
                </tr>

                <tr>
                    <td>estado</td>
                    <td><input type="id_estado" name="id_estado" value="<?php echo $fila['id_estado'] ?>"></td>                 
                </tr>

                <tr>
                    <td>descripcion</td>
                    <td><input type="descripcion" name="descripcion" value="<?php echo $fila['descripcion'] ?>"></td>                 
                </tr>
