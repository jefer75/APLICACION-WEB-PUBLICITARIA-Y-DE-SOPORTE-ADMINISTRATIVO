                            ...
                            <tbody>
                                ...
                                foreach ($resultados as $fila) {
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row"><?php echo $fila['cupos_disponibles'] ?></td>
                                        <td scope="row"><?php echo $fila['precio'] ?></td>
                                        <!-- Agrega un botón de reserva -->
                                        <td><button onclick="reservarEvento(<?php echo $fila['id_evento']; ?>)">Reservar</button></td>
                                    </tr>
                                <?php
                                }
                                ?>
...
<script>
    ...
    function reservarEvento(id_evento) {
        ...
        window.location.href = "reserva.php?id_evento=" + id_evento;
    }
</script>
